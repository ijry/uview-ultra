...
export default {
    ...
    computed: {
        ...
        progressLabel() {
            ...
            return `${chapterText} · ${Math.round(this.progressPercent)}%`
        },
        previousDisabled() {
