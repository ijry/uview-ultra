...
function itemStyle(index) {
	const style = {}
	if (props.actions[index].color) style.color = props.actions[index].color
	if (props.actions[index].fontSize) style.fontSize = addUnit(props.actions[index].fontSize)
	if (props.actions[index].disabled) style.color = '#c0c4cc'
	return style
}
